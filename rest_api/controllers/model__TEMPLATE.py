...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/model.name', methods=['GET', "OPTIONS"], type='http', auth='none', cors="*", csrf=False)
    @check_permissions
    ...
    @http.route('/api/model.name/<id>', methods=['GET', "OPTIONS"], type='http', auth='none', cors="*", csrf=False)
    @check_permissions
    ...
    # Create one:
    @http.route('/api/model.name', methods=['POST', "OPTIONS"], type='http', auth='none', cors="*", csrf=False)
    @check_permissions
    ...
    # Update one:
    @http.route('/api/model.name/<id>', methods=['PUT', "OPTIONS"], type='http', auth='none', cors="*", csrf=False)
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/model.name/<id>', methods=['DELETE', "OPTIONS"], type='http', auth='none', cors="*", csrf=False)
    @check_permissions
    ...
    @http.route('/api/model.name/<id>/<method>', methods=['PUT', "OPTIONS"], type='http', auth='none', cors="*", csrf=False)
    @check_permissions

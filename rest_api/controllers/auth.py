...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/auth/get_tokens', methods=['GET', 'POST', "OPTIONS"], type='http', auth='none', cors="*", csrf=False)
    ...
    @http.route('/api/auth/refresh_token', methods=['POST', "OPTIONS"], type='http', auth='none', cors="*", csrf=False)
    ...
    @http.route('/api/auth/delete_tokens', methods=['POST', "OPTIONS"], type='http', auth='none', cors="*", csrf=False)

...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/<string:model_name>', methods=['GET', "OPTIONS"], type='http', auth='none', cors="*", csrf=False)
    @check_permissions
    ...
    @http.route('/api/<string:model_name>/<id>', methods=['GET', "OPTIONS"], type='http', auth='none', cors="*", csrf=False)
    @check_permissions
    ...
    # Create one:
    @http.route('/api/<string:model_name>', methods=['POST', "OPTIONS"], type='http', auth='none', cors="*", csrf=False)
    @check_permissions
    ...
    # Update one:
    @http.route('/api/<string:model_name>/<id>', methods=['PUT', "OPTIONS"], type='http', auth='none', cors="*", csrf=False)
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/<string:model_name>/<id>', methods=['DELETE', "OPTIONS"], type='http', auth='none', cors="*", csrf=False)
    @check_permissions
    ...
    @http.route('/api/<string:model_name>/<id>/<method>', methods=['PUT', "OPTIONS"], type='http', auth='none', cors="*", csrf=False)
    @check_permissions
